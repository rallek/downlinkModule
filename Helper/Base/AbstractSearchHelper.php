...
abstract class AbstractSearchHelper implements SearchableInterface
{
    ...
    {
        if (!$this->permissionApi->hasPermission('RKDownlinkModule::', '::', ACCESS_READ)) {
            return '';
        }
    ...
    public function getResults(array $words, $searchType = 'AND', $modVars = null)
    {
        ...
        $searchTypes = $this->getSearchTypes();
        $entitiesWithDisplayAction = ['link'];
        ...
        foreach ($searchTypes as $searchTypeCode => $typeInfo) {
            ...
            if (isset($moduleActivationInfo['RKDownlinkModule'])) {
                $moduleActivationInfo = $moduleActivationInfo['RKDownlinkModule'];
            ...
            foreach ($entities as $entity) {
                ...
                if (!$this->permissionApi->hasPermission('RKDownlinkModule:' . ucfirst($objectType) . ':', $entity->getKey() . '::', ACCESS_OVERVIEW)) {
                    continue;
                }
                ...
                if ($hasDisplayAction) {
                    ...
                    $displayUrl = new RouteUrl('rkdownlinkmodule_' . strtolower($objectType) . '_display', $urlArgs);
                }
    
                $result = new SearchResultEntity();
                $result->setTitle($formattedTitle)
                    ->setText($description)
                    ->setModule('RKDownlinkModule')
                    ->setCreated($created)
