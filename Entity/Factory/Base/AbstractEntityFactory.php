...
use RK\DownlinkModule\Entity\Factory\EntityInitialiser;
...
abstract class AbstractEntityFactory
{
    ...
    {
        $entityClass = 'RK\\DownlinkModule\\Entity\\' . ucfirst($objectType) . 'Entity';
     ...
     *
     * @return RK\DownlinkModule\Entity\linkEntity The newly created entity instance
     */
    public function createLink()
    {
        $entityClass = 'RK\\DownlinkModule\\Entity\\LinkEntity';

        $entity = new $entityClass();

        $this->entityInitialiser->initLink($entity);
    ...
    public function getIdField($objectType = '')
    {
        ...
        $entityClass = 'RKDownlinkModule:' . ucfirst($objectType) . 'Entity';
