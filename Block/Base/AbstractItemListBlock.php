...
namespace RK\DownlinkModule\Block\Base;

use Zikula\BlocksModule\AbstractBlockHandler;
use Zikula\Core\AbstractBundle;
use RK\DownlinkModule\Helper\FeatureActivationHelper;
use RK\DownlinkModule\Block\Form\Type\ItemListBlockType;
...
abstract class AbstractItemListBlock extends AbstractBlockHandler
{
    ...
    public function display(array $properties = [])
    {
        ...
        if (!$this->hasPermission('RKDownlinkModule:ItemListBlock:', "$properties[title]::", ACCESS_OVERVIEW)) {
            return '';
        }
        ...
        // create query
        $orderBy = $this->get('rk_downlink_module.model_helper')->resolveSortParameter($objectType, $properties['sorting']);
        ...
        if (in_array($objectType, $this->categorisableObjectTypes)) {
            if ($featureActivationHelper->isEnabled(FeatureActivationHelper::CATEGORIES, $properties['objectType'])) {
                $categoryHelper = $this->get('rk_downlink_module.category_helper');
        ...
        if (empty($properties['title'])) {
            $properties['title'] = $this->__('RKDownlinkModule items');
        }
        ...
        $templateParameters = $this->get('rk_downlink_module.controller_helper')->addTemplateParameters($properties['objectType'], $templateParameters, 'block', []);
    ...
    public function getFormOptions()
    {
        ...
        return [
            ...
            'category_helper' => $this->get('rk_downlink_module.category_helper'),
            'feature_activation_helper' => $this->get('rk_downlink_module.feature_activation_helper')
        ];
    }
    ...
    {
        return '@RKDownlinkModule/Block/itemlist_modify.html.twig';
    }
