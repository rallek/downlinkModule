...
abstract class AbstractKernelListener implements EventSubscriberInterface
{
     ...
     *     `$testMessage = 'Hello from downlink app';
     *     $event->getRequest()->attributes->set('RKDownlinkModule_test', $testMessage);`
     *
     ...
     *     `$testMessage = $event->getRequest()->attributes->get('RKDownlinkModule_test');`
     *     now `$testMessage` should be: `'Hello from downlink app'`
     *
     ...
     *         $response = new Response();
     *         $message = sprintf('downlink App Error says: %s with code: %s', $exception->getMessage(), $exception->getCode());
