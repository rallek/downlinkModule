    ...
    public function onGuard(GuardEvent $event)
    {
        ...
        switch ($transitionName) {
            ...
            case 'demote':
                ...
                break;
            case 'delete':
                $permissionLevel = in_array($objectType, ['link']) ? ACCESS_EDIT : ACCESS_DELETE;
                break;
        }
    
        if (!$this->permissionApi->hasPermission('RKDownlinkModule:' . ucfirst($objectType) . ':', $entity->getKey() . '::', $permissionLevel)) {
