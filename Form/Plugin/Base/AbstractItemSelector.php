...
namespace RK\DownlinkModule\Form\Plugin\Base;
...
class AbstractItemSelector extends Zikula_Form_Plugin_TextInput implements ContainerAwareInterface
{
    ...
    public function render(Zikula_Form_View $view)
    {
        ...
        if ($firstTime) {
            ...
            $jsAssetBag->add($assetHelper->resolve('@RKDownlinkModule:js/RKDownlinkModule.js'));
            $jsAssetBag->add($assetHelper->resolve('@RKDownlinkModule:js/RKDownlinkModule.ItemSelector.js'));
        ...
        if (!$permissionApi->hasPermission('RKDownlinkModule:' . ucfirst($this->objectType) . ':', '::', ACCESS_COMMENT)) {
            return false;
        }

        $categorisableObjectTypes = ['link'];
        $catIds = [];
        ...
        $view = Zikula_View::getInstance('RKDownlinkModule', false);
    ...
    public function decode(Zikula_Form_View $view)
    {
        ...
        $this->objectType = $request->request->get('RKDownlinkModule_objecttype', 'link');
