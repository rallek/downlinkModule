...
namespace RK\DownlinkModule\Form\Type\Finder\Base;
...
/**
 * Link finder form type base class.
 */
abstract class AbstractLinkFinderType extends AbstractType
{
    use TranslatorTrait;
    ...
    public function addCategoriesField(FormBuilderInterface $builder, array $options = [])
    {
        $builder->add('categories', CategoriesType::class, [
            ...
            'entityCategoryClass' => 'RK\DownlinkModule\Entity\\' . ucfirst($options['object_type']) . 'CategoryEntity',
    ...
    public function addPasteAsField(FormBuilderInterface $builder, array $options = [])
    {
        $builder->add('pasteAs', ChoiceType::class, [
            ...
            'empty_data' => 1,
            'choices' => [
                $this->__('Relative link to the link') => 1,
                $this->__('Absolute url to the link') => 2,
                $this->__('ID of link') => 3
            ],
            'multiple' => false,
            'expanded' => false
        ]);
    ...
    {
        return 'rkdownlinkmodule_linkfinder';
    }
