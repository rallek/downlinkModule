...
namespace RK\DownlinkModule\Form\Handler\Common\Base;
...
use RK\DownlinkModule\Helper\HookHelper;
...
abstract class AbstractEditHandler
{
    ...
    public function processForm(array $templateParameters = [])
    {
        ...
        // default to referer
        $refererSessionVar = 'rkdownlinkmodule' . $this->objectTypeCapital . 'Referer';
        ...
        $this->permissionComponent = 'RKDownlinkModule:' . $this->objectTypeCapital . ':';
        ...
        if ($this->templateParameters['mode'] == 'edit') {
            ...
            if (null !== $entity) {
                if (true === $this->hasPageLockSupport && $this->kernel->isBundle('ZikulaPageLockModule') && null !== $this->lockingApi) {
                    ...
                    $lockName = 'RKDownlinkModule' . $this->objectTypeCapital . $entity->getKey();
        ...
        if (false === $actions || !is_array($actions)) {
            ...
            $logArgs = ['app' => 'RKDownlinkModule', 'user' => $this->currentUserApi->get('uname'), 'entity' => $this->objectType, 'id' => $entity->getKey()];
    ...
    public function handleCommand(array $args = [])
    {
        ...
        if ($entity->supportsHookSubscribers()) {
            ...
            if ($action != 'delete') {
                ...
                $routeUrl = new RouteUrl('rkdownlinkmodule_' . $this->objectTypeLower . '_display', $urlArgs);
            }
    ...
    protected function addDefaultMessage(array $args = [], $success = false)
    {
        ...
        $logArgs = ['app' => 'RKDownlinkModule', 'user' => $this->currentUserApi->get('uname'), 'entity' => $this->objectType, 'id' => $this->entityRef->getKey()];
        if (true === $success) {
